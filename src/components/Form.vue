<script setup>
    ...
    function handleImageUpload(event) {
        ...
        if (file) {
            ...
            reader.onload = () => {
            form.value.blog_image = reader.result;
            };
    ...
    <div class="flex items-center justify-center p-12">
        ...
        <div class="mx-auto w-full max-w-[550px]">
            ...
            <form @submit.prevent="handleSubmit" method="POST">
                ...
                <div>
                    <button class="flex hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-base font-semibold text-white outline-none">
                        <span v-if="!formStore.isLoading">Submit</span>

                        <span v-if="formStore.isLoading">Sending</span>

                        <div role="status" class="ml-3" v-if="formStore.isLoading">
                            <svg aria-hidden="true" class="inline w-4 h-4 text-white-200 animate-spin dark:text-white-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
