<script setup>
    ...
    const searchBlog = () => {
        blogStore.searchBlogs(search.value);
    }
...
<template>
    <form @submit.prevent="searchBlog" class="max-w-lg mx-auto">   
        ...
        <div class="relative">
            ...
            <input v-model="search" type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="Search Mockups, Logos..." required />
